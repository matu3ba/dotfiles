...
if status is-interactive
  ...
  abbr --add -g  zbrel ' set -lx ZIG_LIB_DIR lib; ./buildrel/stage3/bin/zig build -p rel -Doptimize=ReleaseSafe --search-prefix "../../zig-bootstrap/master/out/x86_64-linux-musl-native" -Dstatic-llvm -Dno-langref'
