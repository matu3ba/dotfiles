...
return require('packer').startup(function()
  ...
  --use { 'echasnovski/mini.completion' } -- idea: think how to configure nvim-cmp to use something else than C-n|p
  ...
  --use { 'sakhnik/nvim-gdb' } -- idea: fix https://github.com/sakhnik/nvim-gdb/issues/177
