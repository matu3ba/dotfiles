REM clang-tools-extra-17.0.4.src/
mkdir %USERPROFILE%\clang-tools-extra-17.0.4.src\build-release
cd %USERPROFILE%\clang-tools-extra-17.0.4.src\build-release
...
REM mkdir %USERPROFILE%\clang-tools-extra-17.0.4.src\build-debug
REM cd %USERPROFILE%\clang-tools-extra-17.0.4.src\build-debug
