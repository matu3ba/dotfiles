...
# Zig
{
  echo 'source ~/dev/git/zig/zig/master/tools/zig_gdb_pretty_printers.py'
  echo 'source ~/dev/git/zig/zig/master/tools/stage1_gdb_pretty_printers.py'
  echo 'source ~/dev/git/zig/zig/master/tools/stage2_gdb_pretty_printers.py'
} >>"${HOME}/.gdbinit"
